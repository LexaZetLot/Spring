...
import org.example.annotated.DemoBean;
import org.example.annotated.Singer;
...
public class LookupConfigDemo {
    ...
    public static void displayInfo(String beanName, DemoBean bean){
        ...
        System.out.println("[" + beanName + "]: org.example.Singer Instances the Same? " + (singer1 == singer2));
        ...
        stopWatch.stop();
        System.out.println("100000 gets look " + stopWatch.getTotalTimeMillis() + " ms");
    }
}
